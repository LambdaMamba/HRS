...
public class Staff extends Hotel{
    ...
    public static void RedirectToChain(String location){
        ChainName = location;
    }
    ...
    public static void StartCheckin(){
        // System.out.println("Welcome to "+ChainName+"!");
	...
	public static void TerminateCheckOut() {
        if(angryStaff == false){
            System.out.println("Thank you for staying at "+ChainName+"! We hope to see you again!");
