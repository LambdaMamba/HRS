...
public class Staff {
	...
	public static void ReceiveReservationNo() {
        ...
        try{
            ...
            RoomNumber = ReservationProcessor.SearchRoomCorrespondingToReservationNumber(ReservationNumber);
            if(RoomNumber == -1) {
                System.out.println("Your reservation number is not found.");
                TellUserToRebook();
            } else {
                details = ReservationProcessor.FetchOnlineReservationDetails();
	...
	public static void TellFee() {
        try{
            ...
            fee = ReservationProcessor.SearchFeeOfRoomNumber(RoomNumber);
	...
	public static void TerminateCheckOut() {
        ...
        ReservationProcessor.UserHasLeft(RoomNumber);
    ...
    public static void ConductCheckin(){
        ...
        wifi = ReservationProcessor.SeeWifiDetails();
        ReservationProcessor.StartWifi(RoomNumber, wifi);
    }


    public static void ConductCheckout(){
        ReservationProcessor.StartWifi(RoomNumber, false);
    }
