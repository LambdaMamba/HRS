...
public class OnlineReservation {
	...
	public static void CheckAvailableRoom(int userID) {
        ...
        NumberOfAvailableRooms = ReservationProcessor.SearchAvailableRoom(userID);
        ShowNumberOfAvailableRooms();
		ReservationProcessor.CheckHowManyWantToReserveRoom();
	...
	public static void WifiConfirmation(){
			...
			if (WifiNum == '1'){
				wifi = true;
				ReservationProcessor.RegisterReservation(wifi, Date);
				ShowDetails();
			} else if (WifiNum == '0') {
				wifi = false;
				ReservationProcessor.RegisterReservation(wifi, Date);
	...
	public static void UserHereIsSelected() {
        ...
        ReservationNumber = ReservationProcessor.GenerateReservationNumber();
